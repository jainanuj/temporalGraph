...
public:
    ...
    void wuGraph(const char* filePath,int noL = 0);     //input file in wu Format.
    ...
    void collapseIntervalsWriteOuput(const char* filePath);
...
public:
    ...
    int t_start, t_end;
    double time_sum;
	vector <int> arr_time, f_time, father;
